...
class FunController:
    ...
    def beer_command(self, request, item_id):
        return self.get_fun_message("beer", item_id)
    ...
    def brain_command(self, request, item_id):
        return self.get_fun_message("brain", item_id)
    ...
    def chuck_command(self, request, item_id):
        return self.get_fun_message("chuck", item_id)
    ...
    def cybor_command(self, request, item_id):
        return self.get_fun_message("cybor", item_id)
    ...
    def dwight_command(self, request, item_id):
        return self.get_fun_message("dwight", item_id)
    ...
    def fc_command(self, request, item_id):
        return self.get_fun_message("fc", item_id)
    ...
    def homer_command(self, request, item_id):
        return self.get_fun_message("homer", item_id)
    ...
    def pirates_command(self, request, item_id):
        return self.get_fun_message("pirates", item_id)

    def get_fun_message(self, quote_type, number):
        if number is None:
            number = -1
