...
class Budabot(Bot):
    ...
    def start(self):
        ...
        self.setting_manager.register("org_channel_max_page_length", "number", 7500, "", "system")
        self.setting_manager.register("private_message_max_page_length", "number", 7500, "", "system")
        self.setting_manager.register("private_channel_max_page_length", "number", 7500, "", "system")
        self.setting_manager.register("header_color", "color", "", "", "colors")
        self.setting_manager.register("header2_color", "color", "", "", "colors")
        self.setting_manager.register("highlight_color", "color", "", "", "colors")
        self.setting_manager.register("neutral_color", "color", "", "", "colors")
        self.setting_manager.register("omni_color", "color", "", "", "colors")
        self.setting_manager.register("clan_color", "color", "", "", "colors")
