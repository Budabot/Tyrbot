...
class Budabot(Bot):
    ...
    def start(self):
        ...
        self.setting_manager.register("header_color", "color", "", "", "core.colors")
        self.setting_manager.register("header2_color", "color", "", "", "core.colors")
        self.setting_manager.register("highlight_color", "color", "", "", "core.colors")
        self.setting_manager.register("neutral_color", "color", "", "", "core.colors")
        self.setting_manager.register("omni_color", "color", "", "", "core.colors")
        self.setting_manager.register("clan_color", "color", "", "", "core.colors")
        self.setting_manager.register("unknown_color", "color", "", "", "core.colors")
